...
export const SKILL_TREE: SkillConfig[] = [
  {
    ...
    icon: '➕',
    description: 'Jednoduchá sčítání kde výsledek nepřekročí desítku — např. 2+3=5, 12+5=17',
    prerequisites: [],
  },
  {
    id: 'complements_10',
    name: 'Doplňky do 10',
    icon: '🔟',
    description: 'Co chybí do 10? Např. 3+?=10, 6+?=10. Příprava na sčítání přes desítku',
  ...
  },
  {
    ...
    icon: '➕',
    description: 'Sčítání kde výsledek překračuje desítku — např. 7+5=12, 8+6=14',
  ...
  },
  {
    ...
    icon: '➖',
    description: 'Jednoduché odčítání bez přechodu přes desítku — např. 8-3=5, 15-4=11',
  ...
  },
  {
    ...
    icon: '➖',
    description: 'Odčítání přes desítku — musíme si pomoci z vyšší desítky. Např. 12-7=5, 23-8=15',
    prerequisites: [
  ...
  },
  {
    ...
    name: 'Mix +/−',
    icon: '🔢',
    description: 'Sčítání a odčítání dohromady — procvičuje obě operace s přechodem i bez',
    prerequisites: [
